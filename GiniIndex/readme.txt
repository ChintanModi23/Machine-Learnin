...
best split for the CART decision tree algorithm. 
NOTE :: havn't written the CART algorithm in its entirety.
just wrote a program that will traverse all columns in the
