...
If you are working in a group then only one student needs to submit but both names
need to be on the submission document so that we know who the team is. The other student
in the team can leave their submission directory empty.

Directories: /afs/cad/courses/ccs/f18/cs/675/001/<ucid>.
For example if your ucid is abc12 then copy your programs into
/afs/cad/courses/ccs/f18/cs/675/001/abc12.

Your completed program is due before midnight Dec 8th.
